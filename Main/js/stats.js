...
/**Initializes and runs the school stats, with the animation
  *@Input Null
  *
  *@retun NULL
  */
  $(document).ready(function(){
  	...
  	var scrl2 = true;
  	var scrl3 = true;
  	var statsSect = document.querySelectorAll(".title");

  	$(window).bind('scroll', function() {
  		if(isInViewport(statsSect[0]) && scrl1){
  			var stats1 = document.querySelector("#stat1");
  			stats1.classList.remove("hidden");
  			stats1.classList.add("visible");
  			
  			var bar = new ProgressBar.SemiCircle(stat1, {
  				strokeWidth: 6,
  				color: '#FFEA82',
  				trailColor: '#eee',
  				trailWidth: 1,
          ...
          step: (state, bar) => {
          	...
          	var value = Math.round(bar.value() * 5) + " of 5";
          	if (value === 0) {
          		bar.setText('');
          	} else {
          		bar.setText(value);
    ...
    if(isInViewport(statsSect[1]) && scrl2){
    	var stats2 = document.querySelector("#stat2");
    	stats2.classList.remove("hidden");
    	stats2.classList.add("visible");

    	var bar = new ProgressBar.SemiCircle(stat2, {
    		strokeWidth: 6,
    		color: '#BD10E0',
    		trailColor: '#eee',
    		trailWidth: 1,
    ...
    if(isInViewport(statsSect[2]) && scrl3){
    	var stats3 = document.querySelector("#stat3");
    	stats3.classList.remove("hidden");
    	stats3.classList.add("visible");

    	var bar = new ProgressBar.SemiCircle(stat3, {
    		strokeWidth: 6,
    		color: '#FFEA82',
    		trailColor: '#eee',
    		trailWidth: 1,
